use rustikv::lz77::Lz77Encoder;

#[test]
fn test_lz77_roundtrip_simple() {
    let original = b"hello world";
    let compressed = Lz77Encoder::encode(original);
    let decompressed = Lz77Encoder::decode(&compressed);
...
fn test_lz77_compression_ratio() {
    ...
    let compressed = Lz77Encoder::encode(&repetitive);
